...
rm -rf ./package/libs/libnftnl ./package/network/config/firewall ./package/network/utils/nftables
mkdir -p ./package/network/config/firewall ./package/libs/libnftnl ./package/network/utils/nftables
cp -r ./turboacc_tmp/turboacc/shortcut-fe ./package/turboacc
cp -RT ./turboacc_tmp/turboacc/firewall-$(grep -o 'firewall_VERSION=.*' ./turboacc_tmp/turboacc/version | cut -d '=' -f 2)/firewall ./package/network/config/firewall
